...
class Anneal:
    ...
    def evolve(self, func: object) -> None:
        ...
        for key in keys:
            ...
            if isinstance(population[key], tuple):
                ...
                if xbounds[key][1] < xbounds[key][0]:
                    ...
                    print("xbound: ", xbounds)
                    print("xbound-1/0: ", xbounds[key][1], xbounds[key][0])
                    raise MOSAError(
        ...
        for temp in self.__temp:
            ...
            for j in range(self.__niter):
                ...
                xstep[key] = float(self.__xstep[key]) * (temp / self.__initemp)**1.2
                print("STEP SIZE: ", key, xstep[key])
                print("Temp: ", temp, self.__initemp, self.__niter)
        ...
        return temp #<---- Nam added this line
    ...
    def __savecheckpoint(self, x: dict, f: list, population: dict) -> None:
        ...
        # print("Checkpoint stats: ", tmpdict) #<--- Nam editted twice. First time to include "Checkpoint stats: ". Second time to comment out line. Originally: print(tmpdict)
